...
# ΓÜá∩╕Å Issues / Risks / Limitations
...
app.post("/ask", async (req, res) => {
  try {
    ...
    console.log("≡ƒÆ¼ TRUVORA CHAT:", message);
    console.log("≡ƒîÉ WEB ENABLED:", webEnabled);
    console.log("≡ƒùú∩╕Å LANGUAGE:", language);
...
app.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      console.log(
        "≡ƒô╖ IMAGE ANALYSIS REQUEST"
      );


      // ======================================================
      // STEP 1 ΓÇö IMAGE CLASSIFICATION
      // ======================================================
...
Prices can change. Verify the current seller price before purchasing.
      ...
      // ======================================================
      // GENERAL IMAGE ΓÇö DETAILED ANALYSIS
      // ======================================================
      ...
      ffmpeg(videoPath)
        ...
        .on(
          ...
          () => {
            ...
            console.log(
              "Γ£à Frame extraction completed:",
              `uploads/${outputImage}`
            );
  ...
  async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "ΓÜá∩╕Å YouTube transcript unavailable:",
      ...
      if (
        ...
        try {
          ...
          console.log(
            "ΓÜá∩╕Å yt-dlp subtitle fallback failed:",
            ytError.message
          );
  ...
  async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "ΓÜá∩╕Å Could not determine audio duration:",
          error.message
        );
      ...
      if (
        ...
        try {
          ...
          console.error(
            "Γ¥î DIRECT AUDIO TRANSCRIPTION ERROR:",
            error
          );
      ...
      if (
        ...
        for (
          ...
          console.log(
            `≡ƒÄñ Transcribing chunk ${i + 1}/${chunks.length}`
          );
...
# ≡ƒÄÖ∩╕Å Audio Overview

Explain what the audio is about.

# ≡ƒô¥ Full Content Summary
...
# ≡ƒÄ» Actionable Takeaways

Explain useful practical takeaways.

# ΓÜá∩╕Å Unclear / Missing Information
  ...
  async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        console.log(
          "ΓÜá∩╕Å Video duration unavailable:",
          error.message
        );
      }
      ...
      try {
        ...
        console.error(
          "Γ¥î VIDEO AUDIO TRANSCRIPTION ERROR:",
          error.message
        );
...
# ≡ƒº╛ Executive Summary

Provide a clear summary of the entire document.

# ≡ƒôÜ Section-by-Section Analysis
...
# ΓÜá∩╕Å Contradictions / Missing Information
